  ...
  if (reset == true) {
    if(markerIds.size() > 0){
      ...
      for(int i=0;i<depth_point_curr_ok;i++){
	      ...
	      std::cout <<"MarkerW["<<markerIds.at(0)<<"](0,0)="<<MarkerW[markerIds.at(0)].at<float>(0)<< std::endl;
	      std::cout <<"MarkerW["<<markerIds.at(0)<<"](1,0)="<<MarkerW[markerIds.at(0)].at<float>(0)<< std::endl;
	      std::cout <<"MarkerW["<<markerIds.at(0)<<"](2,0)="<<MarkerW[markerIds.at(0)].at<float>(0)<< std::endl;
	      std::cout <<"MC_point["<<markerIds.at(0)<<"][0]="<<MC_point[markerIds.at(0)][0]<< std::endl;
	      std::cout <<"MC_point["<<markerIds.at(0)<<"][1]="<<MC_point[markerIds.at(0)][1]<< std::endl;
	      std::cout <<"MC_point["<<markerIds.at(0)<<"][2]="<<MC_point[markerIds.at(0)][2]<< std::endl;
        ...
        LMWL[i][0]=sqrt((world_point_c[i].x-MarkerW[markerIds.at(0)].at<float>(0))*(world_point_c[i].x-MarkerW[markerIds.at(0)].at<float>(0))+(world_point_c[i].z-MarkerW[markerIds.at(0)].at<float>(2))*(world_point_c[i].z-MarkerW[markerIds.at(0)].at<float>(2)));
...
int main(int argc,char **argv){
  ...
  MarkerW[32]= (cv::Mat_<float>(3, 1) <<0.0, 0.5, 1.9);
