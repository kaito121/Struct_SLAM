...
ofstream Realsec("/home/fuji/catkin_ws/src/Struct_SLAM/src/robot/date/FLD_point2_1_sec.txt");
  ...
  if(time0 != false){
    if (reset == false) {//初回以降動作
      ...
      for(int i=0;i<depth_point_prev_ok;i++){
        ...
        std::cout <<"Est_point["<<i<<"]="<<Est_point[i]<< std::endl;//予測カメラ座標
        std::cout <<"Est_pixel["<<i<<"]="<<Est_pixel[i]<< std::endl;//予測画像座標
      ...
      if(Tracking == true){
        ...
        for(int i=0;i<DMP_prev_ok;i++){
          ...
          std::cout <<"Est_MP_point["<<i<<"]="<<Est_MP_point[i]<< std::endl;//予測カメラ座標
          std::cout <<"Est_MP_pixel["<<i<<"]="<<Est_MP_pixel[i]<< std::endl;//予測画像座標
