  ...
  int NotZeroL=-1;
    ...
    if(req == 1){
      ...
      if(i==0){
        ...
        //measurement.at<float>(2) = max_pt1.y+img_template1.rows/2;//重心位置y座標
        //measurement.at<float>(1) = 100;//重心位置x座標
        //measurement.at<float>(3) = 100;//重心位置y座標

        //measurement.at<float>(0) = max_pt1.x+img_template1.cols/2;//重心位置x座標
        //measurement.at<float>(1) = max_pt1.y+img_template1.rows/2;//重心位置y座標
        ...
        templateY=prediction.at<float>(1)-img_template1.rows/2-abs(prediction.at<float>(3))*5;
        templateCols=img_template1.cols+abs(prediction.at<float>(2))*10;
        templateRows=img_template1.rows+abs(prediction.at<float>(3))*10;
