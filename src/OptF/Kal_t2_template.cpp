  ...
  int NotZeroL=-1;
    ...
    if(req == 1){
      ...
      if(i==0){
        ...
        std::cout <<"測定関数KF.correct(measurement)="<<KF.correct(measurement)<<std::endl;
        std::cout <<"予測関数KF.predict()="<<KF.predict()<<std::endl;
      ...
      if(i==1){
        ...
        std::cout <<"観測座標1_pos.x="<<max_pt1.x+img_template1.cols/2<<std::endl;
        std::cout <<"観測座標1_pos.y="<<max_pt1.y+img_template1.rows/2<<std::endl;
        std::cout <<"measurement1="<<measurement1<<std::endl;
        ...
        std::cout <<"測定関数KF.correct(measurement)="<<KF1.correct(measurement1)<<std::endl;
        std::cout <<"予測関数KF.predict()="<<KF1.predict()<<std::endl;
        ...
        std::cout <<"予測座標1x="<<prediction1.at<float>(0)<<std::endl;
        std::cout <<"予測座標1y="<<prediction1.at<float>(1)<<std::endl;
  
        //templateX=prediction1.at<float>(0)-img_template1.cols/2-abs(prediction.at<float>(2))*5;//カルマンフィルタで予測したマッチング予測範囲
        //templateY=prediction1.at<float>(1)-img_template1.rows/2-abs(prediction.at<float>(3))*5;
