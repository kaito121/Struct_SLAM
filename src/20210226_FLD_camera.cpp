...
//ここに処理項目
    ...
    cv::Mat img_gray,img_edge,img_dst,img_FLD;
    ...
    for (int i = 0; i < lines2.size(); ++i) {
        //線の始点
        cv::Point pt1 = cv::Point2f( lines2[i][0], lines2[i][1] );
        //線の終点
        cv::Point pt2 = cv::Point2f( lines2[i][2], lines2[i][3] );
        cv::line( img_FLD, pt1, pt2, cv::Scalar( 0, 0, 255 ), 2);
    }    
