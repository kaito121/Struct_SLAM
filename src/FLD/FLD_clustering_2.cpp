...
//ここに処理項目
    ...
    for(int i = 0; i < lines.size(); i++){
       ...
       cv::line(img_line,cv::Point(lines[i][0],lines[i][1]),cv::Point(lines[i][2],lines[i][3]),cv::Scalar(0,0,255), 2, cv::LINE_AA); 
  ...
  for (int i=0; i<ksk; ++i) {
    ...
    double yoko[200][20][2][4],tate[200][20][2][4],yokoB,tateB,lines2X,lines2Y,yokolines2[200][5],tatelines2[200][5],yokotheta[200],tatetheta[200];
    ...
    double clusR;
    double yokoclusy[10][200][5],tateclust[10][200][5];
    ...
    if(yoko_histgram == true){
        ...
        cv::line(img_line4,cv::Point(100,380),cv::Point(100+100*sin(modey),380-100*cos(modey)),cv::Scalar(0,255,0), 3, cv::LINE_AA);
        cv::line(img_line4,cv::Point(100,380),cv::Point(100+100*sin(histoy_med),380-100*cos(histoy_med)),cv::Scalar(0,255,100), 3, cv::LINE_AA);
    ...
    if(tate_histgram == true){
        ...
        cv::line(img_line4,cv::Point(100,380),cv::Point(100-100*sin(modet),380+100*cos(modet)),cv::Scalar(0,0,255), 3, cv::LINE_AA);
        cv::line(img_line4,cv::Point(100,380),cv::Point(100-100*sin(histot_med),380+100*cos(histot_med)),cv::Scalar(0,100,255), 3, cv::LINE_AA);
