...
std::string win_depth2 = "depth2";//深度画像+FLD線
...
//ここに処理項目
    ...
    cv::Mat img_gray,img_gray2,img_edge,img_dst,img_line,img_line2,img_line3,img_line4,img_depth2;
    ...
    for(int i = 0; i < lines2.size(); i++){
     ...
     if(dep1[i]>0 && dep2[i]>0){//dep1とdep2が0より大きい時に実行する。(距離データの損失を考慮)
      ...
      std::cout <<"pt1["<<i<<"]("<<lines2[i][0]<<","<<lines2[i][1]<<","<<dep1[i]<<")"<< std::endl;
      std::cout <<"pt2["<<i<<"]("<<lines2[i][2]<<","<<lines2[i][3]<<","<<dep2[i]<<")"<< std::endl;
  ...
  for (int i=0; i<=lines2.size(); ++i) {
    ...
    for(int i = 0; i < yokoyouso; i++){
            ...
            yoko[yokot][yokoj][0][3]=yokotheta[i+1];//代入([3]なのはθで[2]はZだから)

            yoko[yokot][yokoj][1][0]=yokolines2[i+1][2];//代入
            yoko[yokot][yokoj][1][1]=yokolines2[i+1][3];//代入
            yoko[yokot][yokoj][1][3]=yokotheta[i+1];//代入
            std::cout <<"yoko["<<yokot<<"]["<<yokoj<<"][0][0]="<<yoko[yokot][yokoj][0][0]<< std::endl;  
            std::cout <<"yoko["<<yokot<<"]["<<yokoj<<"][0][1]="<<yoko[yokot][yokoj][0][1]<< std::endl;  
            std::cout <<"yoko["<<yokot<<"]["<<yokoj<<"][0][3]="<<yoko[yokot][yokoj][0][3]<< std::endl;  

            std::cout <<"yoko["<<yokot<<"]["<<yokoj<<"][1][0]="<<yoko[yokot][yokoj][1][0]<< std::endl;  
            std::cout <<"yoko["<<yokot<<"]["<<yokoj<<"][1][1]="<<yoko[yokot][yokoj][1][1]<< std::endl;  
            std::cout <<"yoko["<<yokot<<"]["<<yokoj<<"][1][3]="<<yoko[yokot][yokoj][1][3]<< std::endl;  
    ...
    for(int i = 0; i < tateyouso; i++){
            ...
            std::cout <<"tate["<<tatet<<"]["<<tatej<<"][0][0]="<<tate[tatet][tatej][0][0]<< std::endl;  
            std::cout <<"tate["<<tatet<<"]["<<tatej<<"][0][1]="<<tate[tatet][tatej][0][1]<< std::endl;  
            std::cout <<"tate["<<tatet<<"]["<<tatej<<"][0][3]="<<tate[tatet][tatej][0][3]<< std::endl; 

            std::cout <<"tate["<<tatet<<"]["<<tatej<<"][1][0]="<<tate[tatet][tatej][1][0]<< std::endl;  
            std::cout <<"tate["<<tatet<<"]["<<tatej<<"][1][1]="<<tate[tatet][tatej][1][1]<< std::endl;  
            std::cout <<"tate["<<tatet<<"]["<<tatej<<"][1][3]="<<tate[tatet][tatej][1][3]<< std::endl; 
