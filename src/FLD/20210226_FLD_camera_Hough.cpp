...
//ここに処理項目
    ...
    ROS_INFO("callback_functionが呼ばれたよ111111111111111111111111111");
    ...
    ROS_INFO("callback_functionが呼ばれたよ222222222222222222222222222222222222222");
    ...
    for(int i = 0; i < lines.size(); i++){
       ...
       cv::line(img_line2,cv::Point(lines[i][0],lines[i][1]),cv::Point(lines[i][2],lines[i][3]),cv::Scalar(0,0,255), 2, cv::LINE_AA);
    }

    ROS_INFO("callback_functionが呼ばれたよ333333333333333333333333333333333333");
    ...
    for(int i = 0; i < lines2.size(); i++){
       cv::line(img_line2,
            cv::Point(lines2[i][0],lines2[i][1]),
            cv::Point(lines2[i][2],lines2[i][3]),
    ...
    cv::HoughLinesP(img_edge, lines3, 1, CV_PI/180, 80,30,10);

    for(int i = 0; i < lines3.size(); i++){
       cv::line(img_line3,
            cv::Point(lines3[i][0],lines3[i][1]),
            cv::Point(lines3[i][2],lines3[i][3]),
            cv::Scalar(255,0,0), 2, cv::LINE_AA);  }
