...
void callback(const sensor_msgs::Image::ConstPtr& rgb_msg,const sensor_msgs::Image::ConstPtr& depth_msg)
{
    ...
    if(tateyouso==0){
       ...
       for (int j=0; j<clust[MAXT]; ++j) {
        ...
        //cv::rectangle(img_dst, cv::Point(TATE_XN[0]-template_size,TATE_YN[0]+template_size), cv::Point(TATE_XN[0]+template_size,TATE_YN[0]-template_size), cv::Scalar(255, 255, 255), 2, cv::LINE_AA);
        //cv::rectangle(img_dst, cv::Point(TATE_XN[1]-template_size,TATE_YN[1]+template_size), cv::Point(TATE_XN[1]+template_size,TATE_YN[1]-template_size), cv::Scalar(255, 0, 0), 2, cv::LINE_AA);
        //cv::rectangle(img_dst, cv::Point(TATE_XN[2]-template_size,TATE_YN[2]+template_size), cv::Point(TATE_XN[2]+template_size,TATE_YN[2]-template_size), cv::Scalar(0, 255, 0), 2, cv::LINE_AA);
        //cv::rectangle(img_dst, cv::Point(TATE_XN[3]-template_size,TATE_YN[3]+template_size), cv::Point(TATE_XN[3]+template_size,TATE_YN[3]-template_size), cv::Scalar(0, 255, 255), 2, cv::LINE_AA);
