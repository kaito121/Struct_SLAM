...
//ここに処理項目
  ...
  MatrixXd PC(2,L);
   ...
   /* for(j=0;L>j;j++){
    ...
    N(0,0)=0+fx,N(1,0)=-100,PC(0,0)=300+fx,PC(1,0)=200;
    N(0,1)=0+fx,N(1,1)=100,PC(0,1)=300+fx,PC(1,1)=-200;
    N(0,2)=0+fx,N(1,2)=100,PC(0,2)=300+fx,PC(1,2)=400;
    N(0,3)=0+fx,N(1,3)=300,PC(0,3)=300+fx,PC(1,3)=0;
