...
{	
	...
	RGBimage2 = bridgeRGBImage->image.clone();
...
//ここに処理項目
	...
	img_src[1] = RGBimage2;}// 画像読み込み
	//二回目以降
	else{
	img_src[0] = RGBimage; // 画像読み込み
	img_src[1] = RGBimage3;} // 画像読み込み
