...
cv::KalmanFilter KF(4, 2);//(状態ベクトルの次元数,観測ベクトルの次元数)
...
//---------------------------------------------------------------------------------------------------------------------------
  ...
  cv::Mat measurement2(1, 1, CV_32F);// カルマンフィルタ(観測)
