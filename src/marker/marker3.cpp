...
*/
  //画像→カメラ座標変換----------------------------------------------------------------------
    ...
    //一つ前の距離と角度から外部パラメータを算出する(マーカー一つの時)
    Rotation=MAngle[markerIds.at(i)]-MAngle_prve[markerIds.at(i)];//回転ベクトル
    //Translation[0]=
    //V1[0]=
...
/*//tf(map camera_base間のlink)-----------------------------------------------------------------------------------------
   geometry_msgs::Pose camera_base_pose;
    ...
    camera_base_pose.position.x = 0;//ここにカメラオドメトリーが入ると思う
...
/*  //tf(camera_base camera_link間のlink)-----------------------------------------------------------------------------------------
    ...
    Camera_BasetoCamera_Link_pose.orientation.w = 0.1;
...
*/
/*  //tf(map MAP_Marker_link間のlink)-----------------------------------------------------------------------------------------ここでマーカーの世界座標を入力する
    geometry_msgs::Pose MAP_Marker_pose;

    std::string MAP_Marker_frame = "MAP_Marker_link";
    //MAP_Marker_pose.position.x = 0.57;
    //MAP_Marker_pose.position.y = 0.09;
    //MAP_Marker_pose.position.z = 1.07;
    
    MAP_Marker_pose.position.x = 0.51;
    MAP_Marker_pose.position.y = 0.04;
    MAP_Marker_pose.position.z = 0.19;

    MAP_Marker_pose.orientation.w = 0.1;
    static tf::TransformBroadcaster br_MAP_Marker_pose;

    tf::Transform MAP_Marker_transform;
    poseMsgToTF(MAP_Marker_pose, MAP_Marker_transform);
    br_MAP_Marker_pose.sendTransform(tf::StampedTransform(MAP_Marker_transform, ros::Time::now(), "map", MAP_Marker_frame));
*/
/*//tf(MAP_Marker C_Marker間のlink)-----------------------------------------------------------------------------------------ここでMAP_Markerと観測マーカーを結ぶ
    geometry_msgs::Pose MAP_Marker_to_C_Marker_pose;

    std::string MAP_Marker_to_C_Marker_rame = "MAP_Marker_to_C_Marker_link";
    MAP_Marker_to_C_Marker_pose.position.x = 1;
    MAP_Marker_to_C_Marker_pose.position.y = 1;
    MAP_Marker_to_C_Marker_pose.position.z = 1;//ここに実際のカメラの高さを入れる
    MAP_Marker_to_C_Marker_pose.orientation.w = 0.1;
    static tf::TransformBroadcaster br_MAP_Marker_to_C_Marker_pose;

    tf::Transform MAP_Marker_to_C_Marker_pose_transform;
    poseMsgToTF(MAP_Marker_to_C_Marker_pose, MAP_Marker_to_C_Marker_pose_transform);
    br_MAP_Marker_to_C_Marker_pose.sendTransform(tf::StampedTransform(MAP_Marker_to_C_Marker_pose_transform, ros::Time::now(), MAP_Marker_frame, target_maker_frame));
  */  
