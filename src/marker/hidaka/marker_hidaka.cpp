...
//---------------------------------------------------------------------------------------------------------------------------
  ...
  if (markerIds.size() > 0) {
    ...
    if(kaisu!=0){
      //cv::Mat_<float>Pt=(cv::Mat_<float>(6, 1) <<
      //   point[6][0][0],
      //   point[6][0][2],
      //   point[32][0][0],
      //   point[32][0][2],
      ...
      cv::Mat_<float>Pt=(cv::Mat_<float>(4, 1) <<
         point[3][0][0],
         point[3][0][2],
         point[27][0][0],
         point[27][0][2]);

      //cv::Mat_<float>Ot_1=(cv::Mat_<float>(6, 4) << 
      //  point_prve[6][0][0], point_prve[6][0][2], 1, 0,
      //  point_prve[6][0][2], -point_prve[6][0][0], 0, 1,
      //  point_prve[32][0][0], point_prve[32][0][2], 1, 0,
      //  point_prve[32][0][2], -point_prve[32][0][0], 0, 1,
      //  point_prve[33][0][0], point_prve[33][0][2], 1, 0,
      //  point_prve[33][0][2], -point_prve[33][0][0], 0, 1);

      cv::Mat_<float>Ot_1=(cv::Mat_<float>(4, 4) << 
        point_prve[3][0][0], point_prve[3][0][2], 1, 0,
        point_prve[3][0][2], -point_prve[3][0][0], 0, 1,
        point_prve[27][0][0], point_prve[27][0][2], 1, 0,
        point_prve[27][0][2], -point_prve[27][0][0], 0, 1);
      ...
      std::cout <<"XpPLAS="<<XpPLAS<< std::endl;
    }
...
//tf(map camera_base間のlink)-----------------------------------------------------------------------------------------
  ...
  //tf(camera_base camera_link間のlink)-----------------------------------------------------------------------------------------
    ...
    point_prve[3][0][0]=point[3][0][0];
    point_prve[3][0][1]=point[3][0][1];
    point_prve[3][0][2]=point[3][0][2];
    point_prve[6][0][0]=point[6][0][0];
    point_prve[6][0][1]=point[6][0][1];
    point_prve[6][0][2]=point[6][0][2];
    point_prve[27][0][0]=point[27][0][0];
    point_prve[27][0][1]=point[27][0][1];
    point_prve[27][0][2]=point[27][0][2];
    point_prve[32][0][0]=point[32][0][0];
    point_prve[32][0][1]=point[32][0][1];
    point_prve[32][0][2]=point[32][0][2];
    point_prve[33][0][0]=point[33][0][0];
    point_prve[33][0][1]=point[33][0][1];
    point_prve[33][0][2]=point[33][0][2];
